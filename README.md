...
- **Apple Shortcuts (in development):** Dictate with Workbench returns only its own recording to the next text action. Native discovery and end-to-end validation are pending. See [integration notes](docs/voice-integrations.md).
...
Thanks to [@mattywhitenz](https://github.com/mattywhitenz) for the Shortcuts dictation proposal (#10). His optional Speko reading proposal (#11) is being evaluated separately; no account or cloud provider is required.
