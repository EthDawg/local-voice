...
let package = Package(
    ...
    targets: [
        ...
        .executableTarget(name: "LocalVoice", dependencies: ["StageKit", "PhotoHandoffKit", "PresenterKit", .product(name: "FluidAudio", package: "FluidAudio")], swiftSettings: intentSettings, linkerSettings: [.linkedFramework("Carbon")])
    ],
